#!/usr/bin/env python3
"""
Método de la Secante - Aplicación Modular
...
- metodo_secante.py: Algoritmo del método numérico
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Método de la Secante')
    ...
    try:
        if args.interface == 'tkinter':
            from interfaz import InterfazReglaFalsa
