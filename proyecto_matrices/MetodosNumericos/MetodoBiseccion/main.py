"""
Método de Bisección - Aplicación Modular
Autor: Sistema de Análisis Numérico
Versión: 2.0    

Módulos:
- matematicas.py: Funciones matemáticas y validación
- grafico.py: Funciones de graficación
- metodo_biseccion.py: Algoritmo del método numérico
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Método de Bisección')
    ...
    try:
        if args.interface == 'tkinter':
            from interfaz import InterfazBiseccion
            app = InterfazBiseccion()
            app.ejecutar()
        else:  # pyqt
