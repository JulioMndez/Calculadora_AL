...
def evaluar_funcion(func_str, x_val):
    ...
    Retorna float('nan') si hay un error matemático.
    """
    try:
        import re
        ...
        resultado = eval(func_str, allowed_names)
        
        # Si el resultado es un número complejo (ej: sqrt(-1)), retornar nan
        ...
        # Capturar errores matemáticos comunes y retornar nan
        return float('nan')
    except Exception:
        # Para cualquier otro error inesperado, retornar nan
        return float('nan')
